...
class BrandVC: UIViewController,
  ...
  override func viewDidLoad() {
    ...
    arryPhone.append(Phone(photo: UIImage(named: "Honor-Logo")!,brand:"Honor"))
    arryPhone.append(Phone(photo: UIImage(named: "Huawei_Brand")!,brand:"Huawei"))
    arryPhone.append(Phone(photo: UIImage(named: "infinix")!,brand:"Infinix"))
    arryPhone.append(Phone(photo: UIImage(named: "Itel_Brand")!,brand:"Itel"))
    arryPhone.append(Phone(photo: UIImage(named: "Lenovo_logo")!,brand:"Lenovo"))
    arryPhone.append(Phone(photo: UIImage(named: "nokia")!,brand:"Nokia"))
    arryPhone.append(Phone(photo: UIImage(named: "oppo")!,brand:"Oppo"))
    arryPhone.append(Phone(photo: UIImage(named: "Samsung_brand")!,brand:"Samsung"))
    arryPhone.append(Phone(photo: UIImage(named: "Vivo_Logo")!,brand:"Vivo"))
    arryPhone.append(Phone(photo: UIImage(named: "xiaomi_brand")!,brand:"Xiaomi"))
