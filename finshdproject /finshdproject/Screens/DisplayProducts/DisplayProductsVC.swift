...
//    if let index = arr.firstIndex(of: arrSeleced[0]) {
////      allItems.remove(at: index)
//      print("~~ id \(arr[index].id)")
//      print("~~ name \(arr[index].info)")
//      print("~~ isF \(arr[index].isFavorite)")
//
//    }
    
//    print("~~ id \(arrSeleced[0].id)")
//    print("~~ name \(arrSeleced[0].info)")
//    print("~~ isF \(arrSeleced[0].isFavorite)")
  }
